...
nnz_50_10 = [index.nnz(ixs) nnz_];
total_time_50_10_per_nnz = [uf50_10_total pt50_10_total]./nnz_50_10;

figure(2), h = bar(100*[uf50_10([1:4 6],:) pt50_10([1:4 6],:)]); drawnow
set(gca,'xticklabel', l) 

h = legend(strcat(index.Name{ixs(1)},', time/nnz = ', ...
                  num2str(total_time_50_10_per_nnz(1),3),'sec'), ...
           strcat(index.Name{ixs(2)},', time/nnz = ', ...
                  num2str(total_time_50_10_per_nnz(2),3),'sec'), ...
           strcat('Data 2 (ransparse)',', time/nnz = ', ...
                  num2str(total_time_50_10_per_nnz(3),3),'sec'), ...
           'location','NorthWest');
set(h,'fontsize',12,'interpreter','none');
print(gcf,'-depsc2','UF2.eps')
...
nnz_10_50 = [index.nnz(ixs) nnz_];
total_time_10_50_per_nnz = [uf10_50_total pt10_50_total]./nnz_10_50;

figure(3), h = bar(100*[uf10_50([1:4 6],:) pt10_50([1:4 6],:)]); drawnow
set(gca,'xticklabel', l) 

h = legend(strcat(index.Name{ixs(1)},', time/nnz = ', ...
                  num2str(total_time_10_50_per_nnz(1),3),'sec'), ...
           strcat(index.Name{ixs(2)},', time/nnz = ', ...
                  num2str(total_time_10_50_per_nnz(2),3),'sec'), ...
           strcat('Data 3 (ransparse)',', time/nnz = ', ...
                  num2str(total_time_10_50_per_nnz(3),3),'sec'), ...
           'location','NorthWest');
set(h,'fontsize',12,'interpreter','none');
print(gcf,'-depsc2','UF3.eps')